...
setup (name = 'easysvm',
       ...
       packages=['esvm','splicesites','arff','antlr3'],
       scripts=['scripts/easysvm.py','scripts/datagen.py'],
       long_description="""
       easysvm is an easy-to-use front end to the shogun toolbox. It aims 
       to be a 'quick start' tutorial for users interested in shogun. As such,
